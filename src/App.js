...
const Logo = () => {
  return (
    <img
      className="logo"
      alt="Logoo"
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzFDp87OEar1DsoOkxjbczMj6XxuhPWlYhoXu9HhovSMU-XbwWxHgedTOOKQ&s"
    ></img>
  );
};
...
const RestaurantCard = ({
  ...
  return (
    <div className="res-card">
      ...
      {area}</p>
      <p>
        <span className="icon"> <i class="fa-solid fa-star" ></i></span>
...
const Footer = () => {
  ...
  return (
    <div className="footer">
      ...
      <a href="https://www.linkedin.com/in/anurag-rajput-7737ba289?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
        Anurag Rajput
      </a>
